...
.login-form h1, .login-form .judul-register {
    font-size: 2.1rem;
    font-weight: 700;
...
@media (max-width: 500px) {
    ...
    .login-form h1, .login-form .judul-register { font-size: 1.3rem; }
}
</style>
...
<div class="login-container">
    <div class="login-wrapper">
        <form class="login-form" method="post" autocomplete="off">
            ...
            <div class="judul-register text-center">Daftar Akun Baru</div>
            <p class="text-center mb-4" style="font-size:.98rem;color:#338eda;">
                Sistem Pakar Penentuan Pelatihan Kerja
            </p>
            ...
            <div class="form-group position-relative" style="position:relative;">
                ...
                <div style="position:relative;">
                    <input type="password" id="inputPassword" class="form-control" placeholder="Password" name="pass" required style="padding-right:44px;">
            ...
            <div class="text-forgot text-center mt-2">
                <a href="?m=login">Sudah punya akun? Masuk</a>
            </div>
        </form>
    </div>
</div>
